...
public class Deprecated implements AttributeEntry {
	...
	public Deprecated(ConstantPoolEntry[] constpool){
	...
	@Override
	public void print() {
		System.out.printf("\tDeprecated: %s\n", constpool[getDeprecatedIndex() - 1].toString());		
	}
	
	public short getDeprecatedIndex() {
