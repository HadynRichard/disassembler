...
public class Synthetic implements AttributeEntry {
	...
	public Synthetic(ConstantPoolEntry[] constpool){
	...
	@Override
	public void print() {
		System.out.printf("\tSourceFile: %s\n", constpool[getSynthAttributeNameIndex() - 1].toString());
	}
	
	public short getSynthAttributeNameIndex() {
